...
const FALLBACK_DATA = {
  branchData: [
    { shopName: "Kiran Dairy Kharadi", actualRevenue: 145000, expectedRevenue: 175000, totalTransactions: 485 },
    { shopName: "Kiran Dairy Wagholi", actualRevenue: 112000, expectedRevenue: 135000, totalTransactions: 360 },
    { shopName: "Kiran Dairy Hadapsar", actualRevenue: 98000, expectedRevenue: 115000, totalTransactions: 310 },
    { shopName: "Kiran Dairy West Market", actualRevenue: 87000, expectedRevenue: 98000, totalTransactions: 275 },
    { shopName: "Kiran Dairy North Hub", actualRevenue: 76000, expectedRevenue: 88000, totalTransactions: 240 },
  ],
  topBranchesData: [
    { shopName: "Kiran Dairy Kharadi", actualRevenue: 145000, totalTransactions: 485 },
    { shopName: "Kiran Dairy Wagholi", actualRevenue: 112000, totalTransactions: 360 },
    { shopName: "Kiran Dairy Hadapsar", actualRevenue: 98000, totalTransactions: 310 },
    { shopName: "Kiran Dairy West Market", actualRevenue: 87000, totalTransactions: 275 },
    { shopName: "Kiran Dairy North Hub", actualRevenue: 76000, totalTransactions: 240 },
  ],
  staffData: [
    { name: "Ramesh Kumar", monthly: { totalSales: 245, totalAmount: 132000 } },
    { name: "Priya S.", monthly: { totalSales: 220, totalAmount: 118500 } },
    { name: "Sita Devi", monthly: { totalSales: 198, totalAmount: 105000 } },
    { name: "Rajesh M.", monthly: { totalSales: 185, totalAmount: 98000 } },
    { name: "Vijay P.", monthly: { totalSales: 170, totalAmount: 92000 } },
    { name: "Sayali Satam", monthly: { totalSales: 155, totalAmount: 83000 } },
    { name: "Sonika Chavan", monthly: { totalSales: 142, totalAmount: 78000 } },
    { name: "Tanvi Kadam", monthly: { totalSales: 128, totalAmount: 71000 } },
    { name: "Raj Sarang", monthly: { totalSales: 115, totalAmount: 65000 } },
  ]
};
      ...
      <header>
        <nav className="max-w-7xl mx-auto px-4 py-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-sm overflow-hidden border-2 border-white/50">
              <img src={logoImage} alt="Kiran Dairy Farm Logo" className="w-full h-full object-cover scale-[1.4]" />
            </div>
            <div>
              <h1 className="text-xl font-bold text-white/80">Kiran Dairy Farm</h1>
              <p className="text-sm font-bold text-black/80">ERP & POS System</p>
            </div>
          </div>
