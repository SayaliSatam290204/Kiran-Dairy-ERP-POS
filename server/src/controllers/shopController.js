...
export const shopController = {
  ...
  getPreviewData: async (req, res) => {
    try {
      ...
      const staffData = allStaffPerformance.slice(0, 5).map((staff) => ({
        name: staff.name,
        monthly: staff.monthlyPerformance || { totalSales: 0, totalAmount: 0 }
      }));
      ...
      return responseHelper.success(res, {
        ...
        topBranchesData,
        staffData
      }, "Preview analytics loaded successfully");
    } catch (error) {
